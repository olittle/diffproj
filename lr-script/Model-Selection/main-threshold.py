...
#
# Last Modified : Wed 11 Sep 2013 02:43:12 PM CDT
#
...
measure = ["AUC", "AUPR", "logL", "global", "coefficient"]
...
weight_fout = open("./coefficient/coefficient." + str(target_index), "w") 
...
#        beta = Train(Train_Data, year, out_folder, weight)
        ...
        ground_truth = 0
        result_arr = {}
#        result_arr[1], result_arr[2], result_arr[3], result_arr[4], best_m = Test(year + 1, out_folder,  Train_Data, weight, topic, weight_fout)
        Test(year + 1, out_folder,  Train_Data, weight, topic, weight_fout)
